...
#model = load_model("C:\\Users\\91975\\OneDrive\\Desktop\\Major_Project\\cnn9.h5")
...
cv2.imwrite("C:\\Users\\91975\\OneDrive\\Desktop\\Major_Project\\white.jpg", white)
...
while True:
    try:
        ...
        if hands:
            ...
            x, y, w, h = hand['bbox']
            image = frame[y - offset:y + h + offset, x - offset:x + w + offset]
            white = cv2.imread("C:\\Users\\91975\\OneDrive\\Desktop\\Major_Project\\white.jpg")
            # img_final=img_final1=img_final2=0
